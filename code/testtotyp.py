...
def main():
    ...
    feuille: Sheet = createExerciseSheet("Ma Feuille d'exercices", logo=logo_path, author="Moi-même", date="25 Mars 2024", modality=modalities, duration="3 heures", ex=[exo], output="ma_feuille.typ")
